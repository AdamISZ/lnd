...
type CoinJoinRequest struct {
	// / The partially signed bitcoin transaction serialized in hex
	Psbt string `protobuf:"bytes,1,opt,name=psbt" json:"psbt,omitempty"`
	// / The hexlified tweak to construct our destination
	Tweak string `protobuf:"bytes,2,opt,name=tweak" json:"tweak,omitempty"`
	// / The pubkey used to construct our destination
	Pubkey string `protobuf:"bytes,3,opt,name=pubkey" json:"pubkey,omitempty"`
}

func (m *CoinJoinRequest) Reset()                    { *m = CoinJoinRequest{} }
func (m *CoinJoinRequest) String() string            { return proto.CompactTextString(m) }
func (*CoinJoinRequest) ProtoMessage()               {}
func (*CoinJoinRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }

func (m *CoinJoinRequest) GetPsbt() string {
	if m != nil {
		return m.Psbt
	}
	return ""
...
func (m *CoinJoinRequest) GetTweak() string {
	if m != nil {
		return m.Tweak
	}
	return ""
...
func (m *CoinJoinRequest) GetPubkey() string {
	if m != nil {
		return m.Pubkey
	}
	return ""
...
type CoinJoinResponse struct {
	// / The fully signed bitcoin transaction
	FullSignedTx string `protobuf:"bytes,1,opt,name=full_signed_tx" json:"full_signed_tx,omitempty"`
}

func (m *CoinJoinResponse) Reset()                    { *m = CoinJoinResponse{} }
func (m *CoinJoinResponse) String() string            { return proto.CompactTextString(m) }
func (*CoinJoinResponse) ProtoMessage()               {}
func (*CoinJoinResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }

func (m *CoinJoinResponse) GetFullSignedTx() string {
	if m != nil {
		return m.FullSignedTx
	}
	return ""
}

type DecodePSBTRequest struct {
	// / The base64 encoded PSBT object
	B64Psbt string `protobuf:"bytes,1,opt,name=b64psbt" json:"b64psbt,omitempty"`
}

func (m *DecodePSBTRequest) Reset()                    { *m = DecodePSBTRequest{} }
func (m *DecodePSBTRequest) String() string            { return proto.CompactTextString(m) }
func (*DecodePSBTRequest) ProtoMessage()               {}
func (*DecodePSBTRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }

func (m *DecodePSBTRequest) GetB64Psbt() string {
	if m != nil {
		return m.B64Psbt
	}
	return ""
...
// *
// `DecodePSBTResponse` must encapsulate all the data in a Partially
// Signed Bitcoin Transaction in a protobuf format.
type DecodePSBTResponse struct {
	// / The unsigned transaction
	PUnsignedTx string `protobuf:"bytes,1,opt,name=PUnsignedTx" json:"PUnsignedTx,omitempty"`
	// The list of unknown global entries
	PUnknowns []*PUnknown `protobuf:"bytes,2,rep,name=pUnknowns" json:"pUnknowns,omitempty"`
	// / The list of PSBT inputs
	PInputs []*PInput `protobuf:"bytes,3,rep,name=pInputs" json:"pInputs,omitempty"`
	// / The list of PSBT outputs
	POutputs []*POutput `protobuf:"bytes,4,rep,name=pOutputs" json:"pOutputs,omitempty"`
}

func (m *DecodePSBTResponse) Reset()                    { *m = DecodePSBTResponse{} }
func (m *DecodePSBTResponse) String() string            { return proto.CompactTextString(m) }
func (*DecodePSBTResponse) ProtoMessage()               {}
func (*DecodePSBTResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }

func (m *DecodePSBTResponse) GetPUnsignedTx() string {
	if m != nil {
		return m.PUnsignedTx
	}
	return ""
}

func (m *DecodePSBTResponse) GetPUnknowns() []*PUnknown {
	if m != nil {
		return m.PUnknowns
	}
	return nil
...
func (m *DecodePSBTResponse) GetPInputs() []*PInput {
	if m != nil {
		return m.PInputs
	}
	return nil
...
func (m *DecodePSBTResponse) GetPOutputs() []*POutput {
	if m != nil {
		return m.POutputs
	}
	return nil
...
type PUnknown struct {
	// / The key in the PSBT key-value pair, hex encoded
	Key string `protobuf:"bytes,1,opt,name=key" json:"key,omitempty"`
	// / The value in the PSBT key-value pair, hex encoded
	Value string `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
}

func (m *PUnknown) Reset()                    { *m = PUnknown{} }
func (m *PUnknown) String() string            { return proto.CompactTextString(m) }
func (*PUnknown) ProtoMessage()               {}
func (*PUnknown) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *PUnknown) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *PUnknown) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type PInput struct {
	// / The witnessUtxo field in the PSBT input
	WitnessUtxo *PWitnessUtxo `protobuf:"bytes,1,opt,name=witnessUtxo" json:"witnessUtxo,omitempty"`
	// / The nonwitnessUtxo field in the PSBT input;
	// / here hex-encoded and serialized for compactness
	NonWitnessUtxo string `protobuf:"bytes,2,opt,name=nonWitnessUtxo" json:"nonWitnessUtxo,omitempty"`
	// / The sighash type
	SigHashType int32 `protobuf:"varint,3,opt,name=sigHashType" json:"sigHashType,omitempty"`
	// / The partial signatures, if any
	PPartialSigs []*PPartialSig `protobuf:"bytes,4,rep,name=pPartialSigs" json:"pPartialSigs,omitempty"`
	// / The redeemScript, if any, hex encoded
	RedeemScript string `protobuf:"bytes,5,opt,name=redeemScript" json:"redeemScript,omitempty"`
	// / The witnessScript, if any, hex encoded
	WitnessScript string `protobuf:"bytes,6,opt,name=witnessScript" json:"witnessScript,omitempty"`
	// / The BIP32 derivations attached to this input
	PBIP32Derivations []*PBIP32Derivation `protobuf:"bytes,7,rep,name=pBIP32Derivations" json:"pBIP32Derivations,omitempty"`
	// / The finalScriptSig for this input, if any, hex encoded
	FinalScriptSig string `protobuf:"bytes,8,opt,name=finalScriptSig" json:"finalScriptSig,omitempty"`
	// / The finalScriptWitness for this input, if any, hex encoded
	FinalScriptWitness string `protobuf:"bytes,9,opt,name=finalScriptWitness" json:"finalScriptWitness,omitempty"`
	// / Any unknown fields
	PUnknowns []*PUnknown `protobuf:"bytes,10,rep,name=pUnknowns" json:"pUnknowns,omitempty"`
}

func (m *PInput) Reset()                    { *m = PInput{} }
func (m *PInput) String() string            { return proto.CompactTextString(m) }
func (*PInput) ProtoMessage()               {}
func (*PInput) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *PInput) GetWitnessUtxo() *PWitnessUtxo {
	if m != nil {
		return m.WitnessUtxo
	}
	return nil
}

func (m *PInput) GetNonWitnessUtxo() string {
	if m != nil {
		return m.NonWitnessUtxo
	}
	return ""
}

func (m *PInput) GetSigHashType() int32 {
	if m != nil {
...
func (m *PInput) GetPPartialSigs() []*PPartialSig {
	if m != nil {
		return m.PPartialSigs
	}
	return nil
}

func (m *PInput) GetRedeemScript() string {
	if m != nil {
...
func (m *PInput) GetWitnessScript() string {
	if m != nil {
...
func (m *PInput) GetPBIP32Derivations() []*PBIP32Derivation {
	if m != nil {
		return m.PBIP32Derivations
	}
	return nil
}

func (m *PInput) GetFinalScriptSig() string {
	if m != nil {
		return m.FinalScriptSig
	}
	return ""
}

func (m *PInput) GetFinalScriptWitness() string {
	if m != nil {
		return m.FinalScriptWitness
	}
	return ""
}

func (m *PInput) GetPUnknowns() []*PUnknown {
	if m != nil {
		return m.PUnknowns
	}
	return nil
...
type POutput struct {
	// / The redeemScript, if any
	RedeemScript string `protobuf:"bytes,1,opt,name=redeemScript" json:"redeemScript,omitempty"`
	// / The witnessScript, if any
	WitnessScript string `protobuf:"bytes,2,opt,name=witnessScript" json:"witnessScript,omitempty"`
	// / The BIP32 derivations attached to this output
	PBIP32Derivations []*PBIP32Derivation `protobuf:"bytes,3,rep,name=pBIP32Derivations" json:"pBIP32Derivations,omitempty"`
}

func (m *POutput) Reset()                    { *m = POutput{} }
func (m *POutput) String() string            { return proto.CompactTextString(m) }
func (*POutput) ProtoMessage()               {}
func (*POutput) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }

func (m *POutput) GetRedeemScript() string {
	if m != nil {
		return m.RedeemScript
	}
	return ""
...
func (m *POutput) GetWitnessScript() string {
	if m != nil {
		return m.WitnessScript
	}
	return ""
...
func (m *POutput) GetPBIP32Derivations() []*PBIP32Derivation {
	if m != nil {
		return m.PBIP32Derivations
	}
	return nil
...
type PWitnessUtxo struct {
	// / The amount of the output
	Amount int64 `protobuf:"varint,1,opt,name=amount" json:"amount,omitempty"`
	// / The scriptPubkey of the output, hex encoded
	ScriptPubKey string `protobuf:"bytes,2,opt,name=scriptPubKey" json:"scriptPubKey,omitempty"`
	// / The address of the output
	Address string `protobuf:"bytes,3,opt,name=address" json:"address,omitempty"`
}

func (m *PWitnessUtxo) Reset()                    { *m = PWitnessUtxo{} }
func (m *PWitnessUtxo) String() string            { return proto.CompactTextString(m) }
func (*PWitnessUtxo) ProtoMessage()               {}
func (*PWitnessUtxo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }

func (m *PWitnessUtxo) GetAmount() int64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *PWitnessUtxo) GetScriptPubKey() string {
	if m != nil {
...
func (m *PWitnessUtxo) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type PPartialSig struct {
	// / The pubkey for the signature, hex encoded
	PubKey string `protobuf:"bytes,1,opt,name=pubKey" json:"pubKey,omitempty"`
	// / The signature, hex encoded
	Signature string `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
}

func (m *PPartialSig) Reset()                    { *m = PPartialSig{} }
func (m *PPartialSig) String() string            { return proto.CompactTextString(m) }
func (*PPartialSig) ProtoMessage()               {}
func (*PPartialSig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }

func (m *PPartialSig) GetPubKey() string {
	if m != nil {
		return m.PubKey
	}
	return ""
...
func (m *PPartialSig) GetSignature() string {
	if m != nil {
		return m.Signature
	}
	return ""
...
type PBIP32Derivation struct {
	// / The master key fingerprint, hex encoded
	MasterKeyFingerprint string `protobuf:"bytes,1,opt,name=masterKeyFingerprint" json:"masterKeyFingerprint,omitempty"`
	// / The derivation path as a list of integers
	Path []uint32 `protobuf:"varint,2,rep,packed,name=path" json:"path,omitempty"`
	// / The pubkey, hex encoded
	PubKey string `protobuf:"bytes,3,opt,name=pubKey" json:"pubKey,omitempty"`
}

func (m *PBIP32Derivation) Reset()                    { *m = PBIP32Derivation{} }
func (m *PBIP32Derivation) String() string            { return proto.CompactTextString(m) }
func (*PBIP32Derivation) ProtoMessage()               {}
func (*PBIP32Derivation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }

func (m *PBIP32Derivation) GetMasterKeyFingerprint() string {
	if m != nil {
...
func (m *PBIP32Derivation) GetPath() []uint32 {
	if m != nil {
		return m.Path
	}
	return nil
...
func (m *PBIP32Derivation) GetPubKey() string {
	if m != nil {
		return m.PubKey
	}
	return ""
...
func (*NewAddressRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*NewAddressResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*SignMessageRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*SignMessageResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*VerifyMessageRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func (*VerifyMessageResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }
...
func (*ConnectPeerRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }
...
func (*ConnectPeerResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*DisconnectPeerRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*DisconnectPeerResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*HTLC) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (*Channel) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{42} }
...
func (*ListChannelsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{43} }
...
func (*ListChannelsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }
...
func (*ChannelCloseSummary) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{45} }
...
func (*ClosedChannelsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{46} }
...
func (*ClosedChannelsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{47} }
...
func (*Peer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }
...
func (*ListPeersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }
...
func (*ListPeersResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }
...
func (*GetInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }
...
func (*GetInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*ConfirmationUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{53} }
...
func (*ChannelOpenUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
func (*ChannelCloseUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }
...
func (*CloseChannelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{56} }
...
func (*CloseStatusUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57} }
...
func (*PendingUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{58} }
...
func (*OpenChannelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{59} }
...
func (*OpenStatusUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60} }
...
func (*PendingHTLC) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{61} }
...
func (*PendingChannelsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62} }
...
func (*PendingChannelsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63} }
...
func (*PendingChannelsResponse_ClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{63, 3}
}
...
func (*PendingChannelsResponse_ForceClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{63, 4}
}
...
func (*WalletBalanceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{64} }
...
func (*WalletBalanceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{65} }
...
func (*ChannelBalanceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66} }
...
func (*ChannelBalanceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{67} }
...
func (*QueryRoutesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68} }
...
func (*QueryRoutesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{69} }
...
func (*Hop) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70} }
...
func (*Route) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{71} }
...
func (*NodeInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{72} }
...
func (*NodeInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{73} }
...
func (*LightningNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{74} }
...
func (*NodeAddress) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{75} }
...
func (*RoutingPolicy) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{76} }
...
func (*ChannelEdge) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{77} }
...
func (*ChannelGraphRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{78} }
...
func (*ChannelGraph) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{79} }
...
func (*ChanInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{80} }
...
func (*NetworkInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{81} }
...
func (*NetworkInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{82} }
...
func (*StopRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{83} }
...
func (*StopResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{84} }
...
func (*GraphTopologySubscription) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{85} }
...
func (*GraphTopologyUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{86} }
...
func (*NodeUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{87} }
...
func (*ChannelEdgeUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{88} }
...
func (*ClosedChannelUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{89} }
...
func (*HopHint) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{90} }
...
func (*RouteHint) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{91} }
...
func (*Invoice) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{92} }
...
func (*AddInvoiceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{93} }
...
func (*PaymentHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{94} }
...
func (*ListInvoiceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{95} }
...
func (*ListInvoiceResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{96} }
...
func (*InvoiceSubscription) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{97} }
...
func (*Payment) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{98} }
...
func (*ListPaymentsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{99} }
...
func (*ListPaymentsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{100} }
...
func (*DeleteAllPaymentsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{101} }
...
func (*DeleteAllPaymentsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{102} }
...
func (*AbandonChannelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{103} }
...
func (*AbandonChannelResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{104} }
...
func (*DebugLevelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{105} }
...
func (*DebugLevelResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{106} }
...
func (*PayReqString) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{107} }
...
func (*PayReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{108} }
...
func (*FeeReportRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{109} }
...
func (*ChannelFeeReport) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{110} }
...
func (*FeeReportResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{111} }
...
func (*PolicyUpdateRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{112} }
...
func (*PolicyUpdateResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{113} }
...
func (*ForwardingHistoryRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{114} }
...
func (*ForwardingEvent) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{115} }
...
func (*ForwardingHistoryResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{116} }
...
func init() {
	...
	proto.RegisterType((*CoinJoinRequest)(nil), "lnrpc.CoinJoinRequest")
	proto.RegisterType((*CoinJoinResponse)(nil), "lnrpc.CoinJoinResponse")
	proto.RegisterType((*DecodePSBTRequest)(nil), "lnrpc.DecodePSBTRequest")
	proto.RegisterType((*DecodePSBTResponse)(nil), "lnrpc.DecodePSBTResponse")
	proto.RegisterType((*PUnknown)(nil), "lnrpc.PUnknown")
	proto.RegisterType((*PInput)(nil), "lnrpc.PInput")
	proto.RegisterType((*POutput)(nil), "lnrpc.POutput")
	proto.RegisterType((*PWitnessUtxo)(nil), "lnrpc.PWitnessUtxo")
	proto.RegisterType((*PPartialSig)(nil), "lnrpc.PPartialSig")
	proto.RegisterType((*PBIP32Derivation)(nil), "lnrpc.PBIP32Derivation")
...
type LightningClient interface {
	...
	// * lncli: `coinjoin`
	// CoinJoin executes a request to co-sign an existing serialized but only
	// partially signed transaction.
	// The server will sign each input that it recognizes it owns, assuming that
	// it recognizes that it receives as many coins as it spends.
	// The server will optionally broadcast the transaction also.
	CoinJoin(ctx context.Context, in *CoinJoinRequest, opts ...grpc.CallOption) (*CoinJoinResponse, error)
	// * lncli: `decodepsbt`
	// DecodePSBT executes a request to decode a Partially Signed Bitcoin
	// Transaction into a human readable form. The PSBT should be provided
	// in base64 encoding.
	DecodePSBT(ctx context.Context, in *DecodePSBTRequest, opts ...grpc.CallOption) (*DecodePSBTResponse, error)
	// *
...
func (c *lightningClient) CoinJoin(ctx context.Context, in *CoinJoinRequest, opts ...grpc.CallOption) (*CoinJoinResponse, error) {
	out := new(CoinJoinResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/CoinJoin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) DecodePSBT(ctx context.Context, in *DecodePSBTRequest, opts ...grpc.CallOption) (*DecodePSBTResponse, error) {
	out := new(DecodePSBTResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/DecodePSBT", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightningServer interface {
	...
	// it recognizes that it receives as many coins as it spends.
	// The server will optionally broadcast the transaction also.
	CoinJoin(context.Context, *CoinJoinRequest) (*CoinJoinResponse, error)
	// * lncli: `decodepsbt`
	// DecodePSBT executes a request to decode a Partially Signed Bitcoin
	// Transaction into a human readable form. The PSBT should be provided
	// in base64 encoding.
	DecodePSBT(context.Context, *DecodePSBTRequest) (*DecodePSBTResponse, error)
	// *
	// SubscribeTransactions creates a uni-directional stream from the server to
	// the client in which any newly discovered transactions relevant to the
	// wallet are sent over.
...
func _Lightning_CoinJoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CoinJoinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).CoinJoin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/CoinJoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).CoinJoin(ctx, req.(*CoinJoinRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_DecodePSBT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DecodePSBTRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).DecodePSBT(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/DecodePSBT",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).DecodePSBT(ctx, req.(*DecodePSBTRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CoinJoin",
			Handler:    _Lightning_CoinJoin_Handler,
		},
		{
			MethodName: "DecodePSBT",
			Handler:    _Lightning_DecodePSBT_Handler,
		},
		{
			MethodName: "SendMany",
...
var fileDescriptor0 = []byte{
	...
	,
	...
	,
	...
	,
}
